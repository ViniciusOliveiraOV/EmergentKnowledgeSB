...
"en": {
    ...
    "search.pick": "Open result [1-{n}] or choose 0 to go back",
    "search.pick.invalid": "Choose a number between 1 and {n}, or choose 0 to go back.",
...
"pt-BR": {
    ...
    "search.pick": "Abrir resultado [1-{n}] ou escolha 0 para voltar",
    "search.pick.invalid": "Escolha um número entre 1 e {n}, ou escolha 0 para voltar.",
