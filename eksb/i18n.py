...
"en": {
    ...
    "help.unknown": "There is no `eksb {cmd}` command.",
    "help.hint": "Run  eksb help  to see the commands there are.",
    ...
    # -- managing workspaces ------------------------------------------
    "set.manage": "Manage workspaces",
    "mw.title": "Manage workspaces",
    "mw.what": "What would you like to do?",
    "mw.create": "Create a workspace",
    "mw.open": "Open another workspace",
    "mw.forget": "Stop using the current workspace",
    "mw.delete": "Delete current workspace from disk",
    "mw.reset": "Reset the demo to its original contents",
    "ws.forget.none": "No workspace is set, so there is nothing to stop using.",
    "ws.forgotten": "EKSB is no longer using {path}.",
    "ws.forget.safe": "Nothing was deleted. Open it again any time with: eksb open <path>",
    "del.warn": "This permanently deletes {path} and everything inside it.",
    "del.contents": "It currently holds {n} note(s). This cannot be undone.",
    "del.type": "Type the folder name to confirm ({name}), or press Enter to cancel",
    "del.cancelled": "Nothing was deleted.",
    "del.needsyes": "Nothing was deleted. Pass --yes to delete without being asked.",
    "del.done": "Deleted {path}.",
    "del.nodemo": "The demo cannot be deleted here.",
    "del.nodemo.hint": "Use \"Reset the demo\" to restore it, or delete the folder yourself.",
    "del.refused": "EKSB will not delete {path}.",
    "demo.already": "Demo workspace already set up at {path}",
    "demo.reset.hint": "To restore it to its original contents:  eksb demo --reset",
    "demo.reset.warn": "This replaces everything in {path} with the original demo.",
    "demo.reset.confirm": "Restore the demo?",
    "demo.reset.cancelled": "The demo was left as it is.",
    "demo.restoring": "Restoring the demo workspace...",
    "demo.restored": "Demo restored at {path}",
    "demo.notdemo": ("{path} is a workspace of your own, not the demo. "
                     "EKSB will not replace it."),
    ...
    "att.verify.prompt": "Verify which outside claim? [1-{n}, Enter to leave]: ",
    "att.verify.invalid": "That is not one of the claims shown.",
    "att.verify.done": "Verified. Its source attribution was preserved.",
    "att.decisions": "Decide here",
    "att.kind.question": "Open question",
    "att.kind.suggestion": "Assistant suggestion",
    "att.kind.outside": "Outside claim",
    "att.pick.prompt": "Resolve which item? [1-{n}, Enter to leave]: ",
    "att.pick.invalid": "That is not one of the items shown.",
    "att.action.prompt": "1 Confirm  2 Reject  3 Keep pending: ",
    "att.action.invalid": "Choose 1, 2 or 3.",
    "att.action.pending": "Left pending.",
    "att.action.failed": "I could not record that decision: {detail}.",
    "att.confirm.done": "Confirmed. EKSB recorded your endorsement without erasing the original suggestion.",
    "att.reject.done": "Rejected. The original item was left in place with a review marker.",
    "att.resolve.done": "Resolved. The original question was left in place with a review marker.",
...
"pt-BR": {
    ...
    "help.unknown": "Não existe o comando `eksb {cmd}`.",
    "help.hint": "Rode  eksb help  para ver os comandos que existem.",
    ...
    # -- managing workspaces ------------------------------------------
    "set.manage": "Gerenciar workspaces",
    "mw.title": "Gerenciar workspaces",
    "mw.what": "O que você quer fazer?",
    "mw.create": "Criar um workspace",
    "mw.open": "Abrir outro workspace",
    "mw.forget": "Parar de usar o workspace atual",
    "mw.delete": "Apagar o workspace atual do disco",
    "mw.reset": "Restaurar a demonstração ao conteúdo original",
    "ws.forget.none": "Nenhum workspace está definido, então não há o que parar de usar.",
    "ws.forgotten": "O EKSB não está mais usando {path}.",
    "ws.forget.safe": "Nada foi apagado. Reabra quando quiser com: eksb open <caminho>",
    "del.warn": "Isto apaga permanentemente {path} e tudo que houver dentro.",
    "del.contents": "Ele tem {n} nota(s) agora. Não dá para desfazer.",
    "del.type": "Digite o nome da pasta para confirmar ({name}), ou Enter para cancelar",
    "del.cancelled": "Nada foi apagado.",
    "del.needsyes": "Nada foi apagado. Use --yes para apagar sem confirmação digitada.",
    "del.done": "Apagado: {path}.",
    "del.nodemo": "A demonstração não pode ser apagada aqui.",
    "del.nodemo.hint": "Use \"Restaurar a demonstração\" para recuperá-la, ou apague a pasta você mesmo.",
    "del.refused": "O EKSB não vai apagar {path}.",
    "demo.already": "Workspace de demonstração já existe em {path}",
    "demo.reset.hint": "Para restaurar ao conteúdo original:  eksb demo --reset",
    "demo.reset.warn": "Isto substitui tudo em {path} pela demonstração original.",
    "demo.reset.confirm": "Restaurar a demonstração?",
    "demo.reset.cancelled": "A demonstração ficou como estava.",
    "demo.restoring": "Restaurando o workspace de demonstração...",
    "demo.restored": "Demonstração restaurada em {path}",
    "demo.notdemo": ("{path} é um workspace seu, não a demonstração. "
                     "O EKSB não vai substituí-lo."),
    ...
    "att.verify.prompt": "Verificar qual afirmação externa? [1-{n}, Enter para sair]: ",
    "att.verify.invalid": "Essa não é uma das afirmações exibidas.",
    "att.verify.done": "Verificada. A atribuição à fonte foi preservada.",
    "att.decisions": "Decida aqui",
    "att.kind.question": "Pergunta em aberto",
    "att.kind.suggestion": "Sugestão do assistente",
    "att.kind.outside": "Afirmação externa",
    "att.pick.prompt": "Resolver qual item? [1-{n}, Enter para sair]: ",
    "att.pick.invalid": "Esse não é um dos itens exibidos.",
    "att.action.prompt": "1 Confirmar  2 Rejeitar  3 Manter pendente: ",
    "att.action.invalid": "Escolha 1, 2 ou 3.",
    "att.action.pending": "Continuou pendente.",
    "att.action.failed": "Não consegui registrar essa decisão: {detail}.",
    "att.confirm.done": "Confirmado. O EKSB registrou seu endosso sem apagar a sugestão original.",
    "att.reject.done": "Rejeitado. O item original continuou no lugar com um marcador de revisão.",
    "att.resolve.done": "Resolvido. A pergunta original continuou no lugar com um marcador de revisão.",
