...
sources: [src-20260826-chatgpt-fixture-01]   # provenance, see PROVENANCE
...
[[adr-0005-core-instance-separation]].
...
`_system/adr/` records why the architecture is the way it is. ADRs use their
...
The Canonicalizer's `_system/aliases.yml` equivalence table exists to enforce
this mechanically — see [[INGESTION_PIPELINE]] § Canonicalizer step 5.
